...
function GetUnreadNotifications() {
    $.ajax({
        ...
        success: function (result) {
            ...
            if (unreadCount === 0) {
                $('#notification-center-content').append('<div class="card"><div class="card-body"><span id="no-new-notification"><center class="text-secondary"><i class="far fa-thumbs-up text-primary mr-2"></i>No unread notification</center></span></div></div>');
            } else {
    ...
    if (element.read === true) {
        ...
        markRead.click(function () {
            ...
            $.ajax({
                ...
                success: setTimeout(function () {
                    $(this).promise().done(function () {
                        ...
                        checkIcon.fadeOut('fast', function () {
                            ...
                            notificationsHolder.fadeOut('slow', function () {
                                $(this).remove();
                            });
                        })
                    })
                    ...
                    if (unreadCount === 0) {
                        ...
                        $('#notification-center-content')
                            .append('<div class="card"><div class="card-body"><span id="no-new-notification"><center class="text-secondary"><i class="far fa-thumbs-up text-primary mr-2"></i>No unread notification</center></span></div></div>')
                            .fadeIn('slow');
                    } else {
                ...
                error: function () {
                    HandleError('An error occurred', 'Please refresh the page and trya again or contact the customer support.', 'error');
                }
            })
        })
    }
